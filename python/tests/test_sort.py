import unittest
import numpy as np
from python.sort.sort import QuickSort, BubbleSort, InsertionSort
from python.sort.sort import MergeSort as SortSortMergeSort
from python.sort.merge_sort import MergeSort
